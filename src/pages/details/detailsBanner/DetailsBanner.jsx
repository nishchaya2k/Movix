                    ...
                    <ContentWrapper>
                        <div className='content'>
                            ...
                            <div className="right">
                                ...
                                {/* info */}
                                <div className="info">
                                    {data.status && (           //status is released on not
                                        ...
                                        <span className="text">
                                            {director?.map((d, i) => (
                                                <span key={i}>
                                                    ...
                                                    {director.length -
                                                        1 !==
                                                        i && ", "}      {/*there can be more than 1 director */}
                                                </span>
                                            ))}
                                        </span>
                                    </div>
...
<></> --> React Fragment is a feature in React that allows you to return
 multiple elements from a React component by allowing you to group a list
